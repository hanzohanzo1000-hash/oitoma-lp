...
const faqs = [
  {
    ...
    answer:
      "はい、原則としてお客様が会社へ出社する必要はありません。オイトマが代わりに会社へ退職の意思をお伝えし、退職手続きを進めます。ただし、会社の方針や状況によっては、書類の郵送などが必要になる場合があります。",
  },
  {
    question: "即日対応は可能ですか？",
    answer:
  ...
  },
  {
    ...
    answer:
      "会社からの連絡は、原則としてオイトマが対応いたします。お客様が直接対応する必要が生じる場合も、事前にご説明し、サポートいたします。",
  },
];
